!****************************************************************************************
!*   :: Purpose ::                                                                      *
!*   Chapter 3, exercise 1 solution to determining effects of O:C and Morg variations.  *
!*                                                                                      *
!*   :: Authors ::                                                                      *
...
!For a given binary mixture (here  water + 1,6-hexanediol), determine the presence/absence
!of a liquid--liquid phase separation.

!(2.1): set input parameters for the organic component, 1,6-hexanediol, C6H14O2,
...
write(*,'(A,I0,/)') '## Exercise 1 solution -- consideration of LLPS ##'
...
block
    ...
    call dislin_plot(xlabel, ylabel, yaxis_mod=0.75_wp, legend_position=3, &
            & metafile='pdf', out_file_name='exerc1_activity_curves')
end block
...
block
    ...
    call dislin_plot(xlabel, ylabel, yaxis_mod=0.5_wp, legend_position=3, &
            & metafile='pdf', out_file_name='exerc1_Delta_Gmix')
end block
...
block
    ...
    call dislin_plot(xlabel, ylabel, yaxis_mod=0.3_wp, legend_position=3, &
        & metafile='pdf', out_file_name='exerc1_equil_Delta_Gmix')
    !------------------------------------------------------------
    ...
    if (phase_sep_detected) then
        ...
        call dislin_plot(xlabel, ylabel, yaxis_mod=0.25_wp, legend_position=3, &
            & metafile='pdf', out_file_name='exerc1_equil_fracA')
    endif
    !------------------------------------------------------------
    ...
    call dislin_plot(xlabel, ylabel, yaxis_mod=0.3_wp, legend_position=3, &
        & metafile='pdf', out_file_name='exerc1_equil_activity_curves')
    !------------------------------------------------------------
    ...
    if (phase_sep_detected) then
        ...
        call dislin_plot(xlabel, ylabel, yaxis_mod=0.25_wp, legend_position=3, &
            & metafile='pdf', out_file_name='exerc1_equil_qA')
    endif
    !------------------------------------------------------------ 
    ...
    call dislin_plot(xlabel, ylabel, yaxis_mod=0.6_wp, legend_position=3, &
        & metafile='pdf', out_file_name='exerc1_equil_xwtot')
    !------------------------------------------------------------ 
    ...
    call dislin_plot(xlabel, ylabel, yaxis_mod=0.5_wp, legend_position=3, &
        & metafile='pdf', out_file_name='exerc1_equil_lnActCoeff')
    !------------------------------------------------------------
end block

end subroutine BAT_exercise_1